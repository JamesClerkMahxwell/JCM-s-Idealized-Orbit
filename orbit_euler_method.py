import numpy as np #demonstration of energy conservation in an ideal system Euler method
...
def update_physics(): #this WILL cause a disaster
    global pos, vel
...
ax1.set_title("Earth Orbit(EULER METHOD)")
